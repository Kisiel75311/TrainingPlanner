...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { date: @training.date, plan_id: @training.plan_id, status: @training.status, user_id: @training.user_id } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { date: @training.date, plan_id: @training.plan_id, status: @training.status, user_id: @training.user_id } }
